...
#define LJ_MAX_BCINS	(1<<30)		/* Max. # of bytecode instructions. */
#define LJ_MAX_SLOTS	0xffff		/* Max. # of slots in a Lua func. */
#define LJ_MAX_LOCVAR	1000		/* Max. # of local variables. */
#define LJ_MAX_UPVAL	1000		/* Max. # of upvalues. */
